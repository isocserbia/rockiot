...
CREATE OR REPLACE VIEW public.lag_diff_device
 AS
	select
		  ...
		  ldp2.diff_perc as pm25_diff_perc,
		  ldp1.diff_perc as pm10_diff_perc,
	  ...
	  join lag_diff_pm25 ldp2 on ldh.device_id = ldp2.device_id
	  join lag_diff_pm10 ldp1 on ldh.device_id = ldp1.device_id
