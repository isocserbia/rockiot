...
urlpatterns = [
    ...
    path('municipalities/<code>/data/average/', SensorDataAverageMunicipality.as_view(), name='municipality-data-average'),
    ...
    path('facilities/<code>/data/average/', SensorDataAverageFacility.as_view(), name='facility-data-average'),
