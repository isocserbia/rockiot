...
--
SELECT pg_catalog.setval('public.django_celery_beat_intervalschedule_id_seq', 5, true);
...
INSERT INTO public.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority, headers, clocked_id, expire_seconds) VALUES (6, 'celery.backend_cleanup', 'celery.backend_cleanup', '[]', '{}', NULL, NULL, NULL, NULL, true, NULL, 0, '2021-09-22 17:06:00.22197+00', '', 2, NULL, NULL, false, NULL, NULL, '{}', NULL, 43200);
INSERT INTO public.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority, headers, clocked_id, expire_seconds) VALUES (2, 'RabbitMQ health check', 'app.tasks.check_system_health', '[]', '{}', NULL, NULL, NULL, NULL, true, '2021-09-22 17:18:00.355417+00', 24, '2021-09-22 17:18:05.760363+00', '', NULL, 2, NULL, false, NULL, NULL, '{}', NULL, NULL);
INSERT INTO public.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority, headers, clocked_id, expire_seconds) VALUES (1, 'RabbitMQ connections sync', 'app.tasks.update_connections', '[]', '{}', NULL, NULL, NULL, NULL, true, '2021-09-22 17:18:00.722811+00', 72, '2021-09-22 17:18:05.778318+00', '', NULL, 2, NULL, false, NULL, NULL, '{}', NULL, NULL);
INSERT INTO public.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority, headers, clocked_id, expire_seconds) VALUES (3, 'Clean and Calibrate raw data', 'app.tasks.clean_and_calibrate', '[]', '{}', NULL, NULL, NULL, NULL, true, '2021-09-22 17:18:00.29225+00', 12, '2021-09-22 17:18:05.795599+00', '', NULL, 3, NULL, false, NULL, NULL, '{}', NULL, NULL);
INSERT INTO public.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority, headers, clocked_id, expire_seconds) VALUES (7, 'Detect anomalies', 'app.tasks.detect_anomalies', '[]', '{}', NULL, NULL, NULL, NULL, true, '2021-09-22 17:18:00.29225+00', 12, '2021-09-22 17:18:05.795599+00', '', NULL, 4, NULL, false, NULL, NULL, '{}', NULL, NULL);
--
