...
INSERT INTO public.django_celery_beat_intervalschedule (id, every, period) VALUES (4, 60, 'minutes');
--
...
--
INSERT INTO public.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority, headers, clocked_id, expire_seconds) VALUES (4, 'RabbitMQ overview', 'app.tasks.get_overview', '[]', '{}', NULL, NULL, NULL, NULL, true, NULL, 0, '2021-09-22 17:05:53.492904+00', '', NULL, 4, NULL, false, NULL, NULL, '{}', NULL, NULL);
...
INSERT INTO public.django_celery_beat_periodictask (id, name, task, args, kwargs, queue, exchange, routing_key, expires, enabled, last_run_at, total_run_count, date_changed, description, crontab_id, interval_id, solar_id, one_off, start_time, priority, headers, clocked_id, expire_seconds) VALUES (1, 'RabbitMQ connections sync', 'app.tasks.update_connections', '[]', '{}', NULL, NULL, NULL, NULL, true, '2021-09-22 17:18:00.722811+00', 72, '2021-09-22 17:18:05.778318+00', '', NULL, 1, NULL, false, NULL, NULL, '{}', NULL, NULL);
